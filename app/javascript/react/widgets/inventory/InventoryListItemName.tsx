...
const InventoryListItemName = ({
  ...
  return (
    <>
      <span
        className={`btn-link btn-md justify-start ${editingName ? 'hidden' : ''}`}
        onClick={() => toggleForm()}
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2 text-gray-900 dark:text-white hover:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
