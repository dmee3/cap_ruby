...
export default {
  ...
  methods: {
    filterList(searchTerm) {
      ...
      this.displayedList = fuzzysort
        .go(searchTerm, this.entryList, {
          allowTypo: true,
          key: 'searchStr',
          threshold: -50,
        })
    ...
    handleKeydown(event) {
      switch (event.keyCode) {
        ...
        case 13:
          if (
            this.highlighted >= 0 &&
            this.highlighted < this.displayedList.length
          ) {
    ...
    addStaticListEntries() {
      this.entryList.push(
        ...
        },
        {
          type: 'link',
          id: -5,
          url: `/admin/conflicts/new`,
          searchStr: 'new conflict',
