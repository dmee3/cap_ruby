  ...
  render(
    <div className="flex flex-col">
      <div className="flex flex-row items-center justify-between mt-4 mb-2">
        ...
        <div>
          <a href="/admin/users/new" className="bg-green-600 hover:bg-green-300 text-white text-lg px-4 py-2 rounded-md cursor-pointer flex items-center justify-center transition font-medium">
