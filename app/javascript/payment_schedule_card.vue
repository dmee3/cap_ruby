<template>
  <div class="card">
    ...
    <ul class="list-group list-group-flush">
      <li v-for="entry in schedule" v-bind:key="entry.pay_date" class="list-group-item d-flex justify-content-between">
        <span v-bind:class="dateInThePast(entry.pay_date)">{{ formatMoney(entry.amount) }}</span>
