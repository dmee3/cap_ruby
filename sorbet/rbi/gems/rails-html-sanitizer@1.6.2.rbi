...
module ActionView
  class << self
    # source://actionview/7.2.2.2/lib/action_view/deprecator.rb#4
    def deprecator; end

    # source://actionview/7.2.2.2/lib/action_view.rb#93
    def eager_load!; end

    # source://actionview/7.2.2.2/lib/action_view/gem_version.rb#5
    def gem_version; end

    # source://actionview/7.2.2.2/lib/action_view/version.rb#7
    def version; end
  end
end
...
module ActionView::Helpers::SanitizeHelper
  ...
  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#111
  def sanitize(html, options = T.unsafe(nil)); end

  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#116
  def sanitize_css(style); end

  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#12
  def sanitizer_vendor; end

  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#12
  def sanitizer_vendor=(val); end

  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#150
  def strip_links(html); end

  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#133
...
module ActionView::Helpers::SanitizeHelper::ClassMethods
  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#175
  def full_sanitizer; end

  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#155
  def full_sanitizer=(_arg0); end

  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#185
  def link_sanitizer; end

  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#155
  def link_sanitizer=(_arg0); end

  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#195
  def safe_list_sanitizer; end

  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#155
  def safe_list_sanitizer=(_arg0); end

  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#165
  ...
  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#161
  ...
  # source://actionview/7.2.2.2/lib/action_view/helpers/sanitize_helper.rb#157
  def sanitizer_vendor; end
