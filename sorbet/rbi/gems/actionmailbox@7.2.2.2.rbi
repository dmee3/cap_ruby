...
class ActionMailbox::InboundEmail < ::ActionMailbox::Record
  ...
  class << self
    ...
    # source://activerecord/7.2.2.2/lib/active_record/enum.rb#250
    def statuses; end
...
module ActionMailbox::InboundEmail::GeneratedAssociationMethods
  ...
  # source://activestorage/7.2.2.2/lib/active_storage/attached/model.rb#111
  def raw_email; end

  # source://activestorage/7.2.2.2/lib/active_storage/attached/model.rb#116
...
class Rails::Conductor::BaseController < ::ActionController::Base
  ...
  class << self
    ...
    # source://actionview/7.2.2.2/lib/action_view/layouts.rb#211
    def _layout; end

    # source://actionview/7.2.2.2/lib/action_view/layouts.rb#212
