...
class ActiveRecord::Base
  ...
  # source://activerecord/7.2.2.2/lib/active_record/reflection.rb#12
  ...
  # source://activemodel/7.2.2.2/lib/active_model/attribute_methods.rb#71
  def attribute_aliases; end

  # source://activemodel/7.2.2.2/lib/active_model/attribute_methods.rb#71
  def attribute_aliases?; end

  # source://activemodel/7.2.2.2/lib/active_model/attribute_methods.rb#72
  def attribute_method_patterns; end

  # source://activemodel/7.2.2.2/lib/active_model/attribute_methods.rb#72
  def attribute_method_patterns?; end

  # source://activerecord/7.2.2.2/lib/active_record/reflection.rb#13
  def automatic_scope_inversing; end

  # source://activerecord/7.2.2.2/lib/active_record/reflection.rb#13
  def automatic_scope_inversing?; end

  # source://activerecord/7.2.2.2/lib/active_record/reflection.rb#14
  def automatically_invert_plural_associations; end

  # source://activerecord/7.2.2.2/lib/active_record/reflection.rb#14
  def automatically_invert_plural_associations?; end

  # source://activerecord/7.2.2.2/lib/active_record/integration.rb#16
  def cache_timestamp_format; end

  # source://activerecord/7.2.2.2/lib/active_record/integration.rb#16
  def cache_timestamp_format?; end

  # source://activerecord/7.2.2.2/lib/active_record/integration.rb#24
  def cache_versioning; end

  # source://activerecord/7.2.2.2/lib/active_record/integration.rb#24
  def cache_versioning?; end

  # source://activerecord/7.2.2.2/lib/active_record/integration.rb#32
  def collection_cache_versioning; end

  # source://activerecord/7.2.2.2/lib/active_record/integration.rb#32
  def collection_cache_versioning?; end

  # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#183
  def column_for_attribute(name, &_arg1); end

  # source://activerecord/7.2.2.2/lib/active_record/counter_cache.rb#10
  def counter_cached_association_names; end

  # source://activerecord/7.2.2.2/lib/active_record/counter_cache.rb#10
  def counter_cached_association_names?; end

  # source://activerecord/7.2.2.2/lib/active_record/core.rb#97
  def default_connection_handler; end

  # source://activerecord/7.2.2.2/lib/active_record/core.rb#97
  def default_connection_handler?; end

  # source://activerecord/7.2.2.2/lib/active_record/core.rb#99
  def default_role; end

  # source://activerecord/7.2.2.2/lib/active_record/core.rb#99
  def default_role?; end

  # source://activerecord/7.2.2.2/lib/active_record/scoping/default.rb#20
  def default_scope_override; end

  # source://activerecord/7.2.2.2/lib/active_record/scoping/default.rb#19
  def default_scopes; end

  # source://activerecord/7.2.2.2/lib/active_record/core.rb#101
  ...
  # source://activerecord/7.2.2.2/lib/active_record/core.rb#47
  def destroy_association_async_batch_size; end

  # source://activerecord/7.2.2.2/lib/active_record/core.rb#37
  ...
  # source://activemodel/7.2.2.2/lib/active_model/serializers/json.rb#15
  def include_root_in_json; end

  # source://activemodel/7.2.2.2/lib/active_model/serializers/json.rb#15
  def include_root_in_json?; end

  # source://activerecord/7.2.2.2/lib/active_record/locking/optimistic.rb#56
  def lock_optimistically; end

  # source://activerecord/7.2.2.2/lib/active_record/locking/optimistic.rb#56
  def lock_optimistically?; end

  # source://activerecord/7.2.2.2/lib/active_record/core.rb#22
  def logger; end
  ...
  # source://activerecord/7.2.2.2/lib/active_record/nested_attributes.rb#15
  def nested_attributes_options; end

  # source://activerecord/7.2.2.2/lib/active_record/nested_attributes.rb#15
  def nested_attributes_options?; end

  # source://activerecord/7.2.2.2/lib/active_record/normalization.rb#8
  ...
  # source://activerecord/7.2.2.2/lib/active_record/attribute_methods/dirty.rb#50
  def partial_inserts; end

  # source://activerecord/7.2.2.2/lib/active_record/attribute_methods/dirty.rb#50
  def partial_inserts?; end

  # source://activerecord/7.2.2.2/lib/active_record/attribute_methods/dirty.rb#49
  def partial_updates; end

  # source://activerecord/7.2.2.2/lib/active_record/attribute_methods/dirty.rb#49
  def partial_updates?; end

  # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#168
  def pluralize_table_names; end

  # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#168
  def pluralize_table_names?; end

  # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#163
  def primary_key_prefix_type; end

  # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#163
  def primary_key_prefix_type?; end

  # source://activerecord/7.2.2.2/lib/active_record/timestamp.rb#47
  ...
  # source://activerecord/7.2.2.2/lib/active_record/signed_id.rb#13
  def signed_id_verifier_secret; end

  # source://activerecord/7.2.2.2/lib/active_record/signed_id.rb#13
  def signed_id_verifier_secret?; end

  # source://activerecord/7.2.2.2/lib/active_record/attribute_methods/time_zone_conversion.rb#71
  def skip_time_zone_conversion_for_attributes; end

  # source://activerecord/7.2.2.2/lib/active_record/attribute_methods/time_zone_conversion.rb#71
  def skip_time_zone_conversion_for_attributes?; end

  # source://activerecord/7.2.2.2/lib/active_record/inheritance.rb#43
  def store_full_class_name; end

  # source://activerecord/7.2.2.2/lib/active_record/inheritance.rb#43
  def store_full_class_name?; end

  # source://activerecord/7.2.2.2/lib/active_record/inheritance.rb#47
  def store_full_sti_class; end

  # source://activerecord/7.2.2.2/lib/active_record/inheritance.rb#47
  def store_full_sti_class?; end

  # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#164
  def table_name_prefix; end

  # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#164
  def table_name_prefix?; end

  # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#165
  def table_name_suffix; end

  # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#165
  def table_name_suffix?; end

  # source://activerecord/7.2.2.2/lib/active_record/attribute_methods/time_zone_conversion.rb#70
  def time_zone_aware_attributes; end

  # source://activerecord/7.2.2.2/lib/active_record/attribute_methods/time_zone_conversion.rb#70
  def time_zone_aware_attributes?; end

  # source://activerecord/7.2.2.2/lib/active_record/attribute_methods/time_zone_conversion.rb#72
  ...
  class << self
    ...
    # source://activerecord/7.2.2.2/lib/active_record/readonly_attributes.rb#11
    ...
    # source://activerecord/7.2.2.2/lib/active_record/counter_cache.rb#9
    ...
    # source://activerecord/7.2.2.2/lib/active_record/core.rb#24
    ...
    # source://activemodel/7.2.2.2/lib/active_model/callbacks.rb#144
    ...
    # source://activerecord/7.2.2.2/lib/active_record/core.rb#120
    def application_record_class?; end

    # source://activemodel/7.2.2.2/lib/active_model/callbacks.rb#137
    ...
    # source://activerecord/7.2.2.2/lib/active_record/core.rb#140
    def asynchronous_queries_session; end

    # source://activerecord/7.2.2.2/lib/active_record/core.rb#144
    ...
    # source://activerecord/7.2.2.2/lib/active_record/core.rb#118
    ...
    # source://activemodel/7.2.2.2/lib/active_model/callbacks.rb#130
    ...
    # source://acts_as_paranoid/0.11.0/lib/acts_as_paranoid/associations.rb#15
    def belongs_to(target, scope = T.unsafe(nil), options = T.unsafe(nil)); end

    # source://activerecord/7.2.2.2/lib/active_record/core.rb#89
    ...
    # source://activerecord/7.2.2.2/lib/active_record/associations.rb#1659
    ...
    # source://activerecord/7.2.2.2/lib/active_record/core.rb#77
    def configurations; end

    # source://activerecord/7.2.2.2/lib/active_record/core.rb#71
    def configurations=(config); end

    # source://activerecord/7.2.2.2/lib/active_record/core.rb#204
    def connected_to_stack; end

    # source://activerecord/7.2.2.2/lib/active_record/core.rb#218
    def connection_class; end

    # source://activerecord/7.2.2.2/lib/active_record/core.rb#214
    def connection_class=(b); end

    # source://activerecord/7.2.2.2/lib/active_record/core.rb#222
    def connection_class?; end

    # source://activerecord/7.2.2.2/lib/active_record/core.rb#226
    def connection_class_for_self; end

    # source://activerecord/7.2.2.2/lib/active_record/core.rb#132
    def connection_handler; end

    # source://activerecord/7.2.2.2/lib/active_record/core.rb#136
    ...
    # source://activerecord/7.2.2.2/lib/active_record/core.rb#195
    def current_preventing_writes; end

    # source://activerecord/7.2.2.2/lib/active_record/core.rb#158
    def current_role; end

    # source://activerecord/7.2.2.2/lib/active_record/core.rb#176
    def current_shard; end

    # source://activerecord/7.2.2.2/lib/active_record/attribute_methods/serialization.rb#20
    ...
    # source://activerecord/7.2.2.2/lib/active_record/core.rb#27
    ...
    # source://activerecord/7.2.2.2/lib/active_record/core.rb#87
    ...
    # source://activerecord/7.2.2.2/lib/active_record/token_for.rb#11
    def generated_token_verifier; end

    # source://activerecord/7.2.2.2/lib/active_record/token_for.rb#11
    def generated_token_verifier=(value); end

    # source://activerecord/7.2.2.2/lib/active_record/core.rb#93
    ...
    # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#170
    ...
    # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#169
    ...
    # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#172
    def inheritance_column; end

    # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#326
    def inheritance_column=(value); end

    # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#172
    def inheritance_column?; end

    # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#167
    ...
    # source://activerecord/7.2.2.2/lib/active_record/store.rb#101
    ...
    # source://activerecord/7.2.2.2/lib/active_record/core.rb#95
    ...
    # source://activerecord/7.2.2.2/lib/active_record/model_schema.rb#166
    ...
    # source://activerecord/7.2.2.2/lib/active_record/core.rb#103
    ...
    # source://activerecord/7.2.2.2/lib/active_record/core.rb#91
    ...
    # source://activerecord/7.2.2.2/lib/active_record/core.rb#241
    ...
    # source://activerecord/7.2.2.2/lib/active_record/token_for.rb#10
...
class ActiveStorage::AnalyzeJob < ::ActiveStorage::BaseJob
  ...
  class << self
    # source://activejob/7.2.2.2/lib/active_job/queue_name.rb#55
    def queue_name; end

    # source://activesupport/7.2.2.2/lib/active_support/rescuable.rb#15
...
class ActiveStorage::Attached::One < ::ActiveStorage::Attached
  ...
  # source://activesupport/7.2.2.2/lib/active_support/delegation.rb#166
  def method_missing(method, *_arg1, **_arg2, &_arg3); end
  ...
  # source://activesupport/7.2.2.2/lib/active_support/delegation.rb#158
  def respond_to_missing?(name, include_private = T.unsafe(nil)); end
end
...
module ActiveStorage::Attachment::GeneratedAssociationMethods
  ...
  # source://activerecord/7.2.2.2/lib/active_record/associations/builder/singular_association.rb#32
  def build_blob(*args, &block); end

  # source://activerecord/7.2.2.2/lib/active_record/associations/builder/singular_association.rb#36
  def create_blob(*args, &block); end

  # source://activerecord/7.2.2.2/lib/active_record/associations/builder/singular_association.rb#40
  def create_blob!(*args, &block); end
...
class ActiveStorage::BaseController < ::ActionController::Base
  ...
  # source://actionview/7.2.2.2/lib/action_view/layouts.rb#328
  ...
  class << self
    ...
    # source://actionpack/7.2.2.2/lib/action_controller/metal/etag_with_template_digest.rb#31
    def etag_with_template_digest; end

    # source://actionpack/7.2.2.2/lib/action_controller/metal.rb#288
...
class ActiveStorage::Blob < ::ActiveStorage::Record
  ...
  # source://actiontext/7.2.2.2/lib/action_text/engine.rb#49
  ...
  # source://actiontext/7.2.2.2/lib/action_text/engine.rb#45
  def previewable_attachable?; end

  def purge; end
  def purge_later; end

  # source://activerecord/7.2.2.2/lib/active_record/secure_token.rb#53
  ...
  # source://actiontext/7.2.2.2/lib/action_text/engine.rb#53
...
class ActiveStorage::Current < ::ActiveSupport::CurrentAttributes
  class << self
    # source://activesupport/7.2.2.2/lib/active_support/current_attributes.rb#195
    def defaults; end

    # source://activesupport/7.2.2.2/lib/active_support/current_attributes.rb#137
    def url_options; end

    # source://activesupport/7.2.2.2/lib/active_support/current_attributes.rb#138
...
class ActiveStorage::FixtureSet
  ...
  # source://activesupport/7.2.2.2/lib/active_support/testing/file_fixtures.rb#20
...
class ActiveStorage::LogSubscriber < ::ActiveSupport::LogSubscriber
  ...
  class << self
    # source://activesupport/7.2.2.2/lib/active_support/log_subscriber.rb#84
    def log_levels; end
  end
end
