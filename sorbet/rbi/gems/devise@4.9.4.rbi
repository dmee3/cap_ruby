...
class ActionDispatch::Routing::Mapper
  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/mapper.rb#2349
  ...
  class << self
    # source://actionpack/7.2.2.2/lib/action_dispatch/routing/mapper.rb#27
    def backtrace_cleaner; end

    # source://actionpack/7.2.2.2/lib/action_dispatch/routing/mapper.rb#27
    def backtrace_cleaner=(val); end

    # source://actionpack/7.2.2.2/lib/action_dispatch/routing/mapper.rb#429
    def normalize_name(name); end

    # source://actionpack/7.2.2.2/lib/action_dispatch/routing/mapper.rb#414
    def normalize_path(path); end

    # source://actionpack/7.2.2.2/lib/action_dispatch/routing/mapper.rb#26
...
class ActionDispatch::Routing::RouteSet
  ...
  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#384
  def initialize(config = T.unsafe(nil)); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#664
  def add_polymorphic_mapping(klass, options, &block); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#633
  def add_route(mapping, name); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#668
  def add_url_helper(name, options, &block); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#415
  def api_only?; end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#454
  def append(&block); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#893
  def call(env); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#478
  def clear!; end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#428
  def default_env; end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#354
  def default_scope; end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#354
  def default_scope=(_arg0); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#356
  def default_url_options; end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#356
  def default_url_options=(_arg0); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#499
  def define_mounted_helper(name, script_namer = T.unsafe(nil)); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#355
  def disable_clear_and_finalize; end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#355
  def disable_clear_and_finalize=(_arg0); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#447
  def draw(&block); end
  ...
  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#404
  def eager_load!; end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#629
  def empty?; end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#357
  def env_key; end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#808
  def extra_keys(options, recall = T.unsafe(nil)); end

  # source://devise//lib/devise/rails/routes.rb#8
  def finalize!; end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#836
  ...
  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#29
  def from_requirements(requirements); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#812
  def generate_extras(options, recall = T.unsafe(nil)); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#526
  def generate_url_helpers(supports_path); end

  def inspect; end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#495
  ...
  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#832
  def optimize_routes_generation?; end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#840
  def path_for(options, route_name = T.unsafe(nil), reserved = T.unsafe(nil)); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#357
  def polymorphic_mappings; end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#458
  def prepend(&block); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#899
  def recognize_path(path, environment = T.unsafe(nil)); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#914
  def recognize_path_with_request(req, path, extras, raise_on_missing: T.unsafe(nil)); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#411
  def relative_url_root; end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#419
  ...
  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#845
  def url_for(options, route_name = T.unsafe(nil), url_strategy = T.unsafe(nil), method_name = T.unsafe(nil), reserved = T.unsafe(nil)); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#518
  def url_helpers(supports_path = T.unsafe(nil)); end

  private

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#462
  def eval_block(block); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#823
  def generate(route_name, options, recall = T.unsafe(nil), method_name = T.unsafe(nil)); end

  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#423
  def make_request(env); end

  class << self
    # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#361
    def default_resources_path_names; end

    # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#365
...
class Devise::Controllers::Responder < ::ActionController::Responder
  class << self
    ...
    #
    # source://responders/3.2.0/lib/action_controller/responder.rb#123
    def error_status; end

    # source://responders/3.2.0/lib/action_controller/responder.rb#124
...
class Devise::FailureApp < ::ActionController::Metal
  ...
  # source://actionpack/7.2.2.2/lib/action_dispatch/routing/url_for.rb#100
  def default_url_options; end
  ...
  # source://activesupport/7.2.2.2/lib/active_support/configurable.rb#115
  def logger; end

  # source://activesupport/7.2.2.2/lib/active_support/configurable.rb#116
  def logger=(value); end

  # source://actionpack/7.2.2.2/lib/abstract_controller/callbacks.rb#36
  def raise_on_missing_callback_actions; end

  # source://actionpack/7.2.2.2/lib/abstract_controller/callbacks.rb#36
  def raise_on_missing_callback_actions=(val); end

  # source://actionpack/7.2.2.2/lib/action_controller/metal/redirecting.rb#17
  ...
  class << self
    ...
    # source://actionpack/7.2.2.2/lib/action_dispatch/routing/route_set.rb#600
    def _routes; end
